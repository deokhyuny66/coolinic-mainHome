                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                        ...
                        <p>Unzip the <code>boots4-v3.1.1.zip</code> to any folder and open a command line or terminal at that location. Boots4's dev tools require
                          ...
                          install
                          <a href="https://gulpjs.com/" target="_blank">Gulp CLI</a> package globally with the following command:</p>
                        <pre class="language-html"><code>npm i gulp-cli -g</code></pre>
                        <p class="mt-4">When you’re done, install the rest of the Boots4's dependencies with:</p>
                        <pre class="language-html"><code>npm i</code></pre>
                        <p class="mt-4">Now run:</p>
                        <pre class="language-html"><code>gulp</code></pre>
                        ...
                        <pre class="language-html"><code>pages/*.html
pages//assets/fonts/
pages//assets/img/
scss/ 
js/</code></pre>
                        ...
                        <pre class="language-html">js/bootstrap/
scss/bootstrap/
pages//assets/css/
pages//assets/js/
pages//assets/lib/
                        ...
                        <p class="mt-3">Within your Boots4 you’ll find the following directories and files, grouping common resources and providing both compiled, transpiled and minified distribution files, as well as raw source files.</p>
                        <pre class="language-html">boots4-v3.1.1/
  ├── js/
  |   ├── bootstrap/
  |   ├── boots4/
  |   └── plugins/
...
js/</code></pre>
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>Compiles <code>scss/theme.scss</code> and generates <code>theme.min.css</code>, and <code>theme.min.map</code> to the <code>pages//assets/css/ </code> directory.
                                </td>
                              </tr>
                              <tr>
                                <td class="text-nowrap"><code>scss:rtl</code></td>
                                <td>Compiles <code>scss/theme.scss</code> and generates <code>theme-rtl.css</code>, and <code>theme-rtl.map</code> to the <code>pages//assets/css/ </code> directory.
                                </td>
                              </tr>
                              <tr>
                                <td class="text-nowrap"><code>scss:rtl:min</code></td>
                                <td>Compiles <code>scss/theme.scss</code> and generates <code>theme-rtl.min.css</code>, and <code>theme-rtl.min.map</code> to the <code>pages//assets/css/ </code> directory.
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <p class="mt-4">To add/replace a new page in <code>Boots4 v3.1.1 </code>you should set a unique id to <code>.page </code>element and also assign it to <code>data-content </code>attribute of <code>.sidebar-item-wrapper </code>for navigating this
                          page from sidebar nav. For example, if we want to add <strong>feature </strong>page in <code>nav-four-item-two-column.html </code>the following code need to set inside <code>#gridNav </code></p>
                        <pre class="language-html mb-4"><code>&lt;div class=&quot;position-relative w-lg-50 position-lg-fixed four-item-two-column&quot; id=&quot;gridNav&quot;&gt;
  ...
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
                        <p class="mt-4">Now <code>four-item-two-column.html </code>page structure will look like this</p>
                        <pre class="language-html mb-0"><code>&lt;main&gt;
...
&lt;/main&gt;</code></pre>
                        ...
                        <p class="font-weight-bold text-sans-serif mb-0">Step 1:</p>
                        <pre><code class="lang-js">npm install lightbox2 -S</code></pre>
                        <p class="font-weight-bold text-sans-serif mb-0 mt-3">Step 2:</p>
                        <p>In your <code>gulpfile.js</code>, add the plugin at the end of the <code>Paths.DEPENDENCIES</code> variable. eg:</p>
	...
	...
                        ...
                        <pre><code class="lang-js">gulp copy:dependency
</code></pre>
                        ...
                        <pre class="language-html"><code>&lt;span data-countup=&quot;7499&quot;&gt;0&lt;/span&gt;</code></pre>
                        ...
                        <h5 class="mt-3">Example</h5>
                        <pre class="language-html"><code>&lt;a href=&quot;/assets/img/projects/your-preview-image.jpg&quot; data-lightbox=&quot;image&quot; data-title=&quot;my caption&quot;&gt;
...
&lt;/a&gt;</code></pre>
                        ...
                        <h5 class="mt-3">Example</h5>
                        <pre class="language-html"><code>&lt;div class=&quot;owl-carousel owl-theme owl-dots-inner owl-theme-white&quot; data-options='{&quot;items&quot;:1,&quot;autoplay&quot;:true,&quot;loop&quot;:true,&quot;animateOut&quot;:&quot;fadeOut&quot;}'&gt;
...
&lt;/div&gt;</code></pre>
                        ...
                        <h5 class="mt-3">Example</h5>
                        <pre class="language-html"><code>&lt;a class=&quot;btn btn-primary&quot; href=&quot;#&quot; data-remodal-target=&quot;modal&quot;&gt;Show Modal&lt;/a&gt;</code></pre>
                        ...
                        <h5 class="mt-3">Example</h5>
                        <pre class="language-html"><code>&lt;div class=&quot;ui styled fluid accordion mt-4 border-0&quot; data-options='{&quot;exclusive&quot;:false}'&gt;
  &lt;h5 class=&quot;title active&quot;&gt;&lt;span class=&quot;fas fa-plus mr-1 text-800&quot; data-fa-transform=&quot;shrink-6 down-1.5&quot;&gt;&lt;/span&gt; What is Boots4?&lt;/h5&gt;
  &lt;div class=&quot;content pl-5 active&quot;&gt;
...
&lt;/div&gt;</code></pre>
                        ...
                        <h5 class="mt-3">Example</h5>
                        <pre class="language-html"><code>&lt;section class=&quot;text-center py-7&quot;&gt;
...
&lt;/section&gt;</code></pre>
                        ...
                        <p>You can also specify where to send the data via an hidden input:</p>
                        <pre class="language-html"><code>&lt;input type=&quot;hidden&quot; name=&quot;to&quot; value=&quot;username@domain.extension&quot; /&gt;</code></pre>
                        <pre></pre> Other reserved <code>name</code> fields are: <code>subject</code>, <code>email</code>, <code>name</code>
                        ...
                        <pre class="language-html"><code>&lt;form class=&quot;zform&quot; method=&quot;post&quot;&gt;
  &lt;div class=&quot;form-group&quot;&gt;
    &lt;input class=&quot;form-control&quot; type=&quot;hidden&quot; name=&quot;to&quot; value=&quot;username@domain.extension&quot; /&gt;
  &lt;/div&gt;
  &lt;div class=&quot;form-group row&quot;&gt;
...
&lt;/form&gt;</code></pre>
                        ...
                        <pre class="language-html"><code>&lt;script src=&quot;https://www.google.com/recaptcha/api.js&quot;&gt;&lt;/script&gt;</code></pre>
                        <h5 class="mt-5">PHP</h5>
                        <p>Open <code>/assets/php/form-processor.php</code> and change the secret key with yours at <code>line: 13</code></p>
                        <pre class="language-html"><code>$reCaptchaSecret = &quot;YOUR_SECRET_KEY&quot;;</code></pre>
                        <h3 class="pt-5 pt-lg-6" id="google-map">Google Map
                          <a href="#google-map">#</a>
                        </h3>
                        ...
                        <h5 class="mt-5">HTML</h5>
                        <pre class="language-html"><code>&lt;div class=&quot;googlemap minh-50vh&quot; data-latlng=&quot;48.8583701,2.2922873,17&quot; data-scrollwheel=&quot;false&quot; data-icon=&quot;/assets/img/map-marker.png&quot; data-zoom=&quot;17&quot; data-theme=&quot;Default&quot;&gt;
  &lt;div class=&quot;marker-content py-3&quot;&gt;
    &lt;h5&gt;Eiffel Tower&lt;/h5&gt;
    &lt;p&gt;Gustave Eiffel's iconic, wrought-iron 1889 tower,
      &lt;br/&gt; with steps and elevators to observation decks.&lt;/p&gt;
...
&lt;/div&gt;</code></pre>
                        <h5 class="mt-5">JavaScript</h5>
                        <pre><code class="lang-html">&lt;script src=&quot;https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&amp;callback=initMap&quot; async&gt;&lt;/script&gt;
</code></pre>
                        <a class="text-sans-serif" href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">Get your API key<span class="d-inline-block ml-1">&xrarr;</span></a>
                        <h5 class="mt-5">Map color schemes</h5>
                        ...
                        <p>With <code>AssassianCreed</code> scheme</p>
                        ...
                        <h5 class="mt-5">HTML</h5>
                        <pre class="language-html"><code>&lt;div class=&quot;googlemap minh-50vh&quot; data-latlng=&quot;48.8583701,2.2922873,17&quot; data-scrollwheel=&quot;false&quot; data-icon=&quot;/assets/img/map-marker.png&quot; data-zoom=&quot;17&quot; data-theme=&quot;AssassianCreed&quot;&gt;
  &lt;div class=&quot;marker-content py-3&quot;&gt;
    &lt;h5&gt;Eiffel Tower&lt;/h5&gt;
    &lt;p&gt;Gustave Eiffel's iconic, wrought-iron 1889 tower,
      &lt;br/&gt; with steps and elevators to observation decks.&lt;/p&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
                        <h5 class="mt-5">Example of street view</h5>
                        ...
                        <h5 class="mt-5">HTML</h5>
                        <pre class="language-html"><code>&lt;div class=&quot;googlemap minh-100vh&quot; data-latlng=&quot;48.8588723,2.2932638&quot; data-pov='{&quot;heading&quot;:120,&quot;pitch&quot;:0}' data-scrollwheel=&quot;false&quot; data-icon=&quot;/assets/img/map-marker.png&quot; data-zoom=&quot;1&quot; data-theme=&quot;streetview&quot;&gt;
&lt;/div&gt;</code></pre>
                        <h3 class="pt-5 pt-lg-6" id="changelog">Changelog
                          <a href="#changelog">#</a>
                        </h3>
                        <h5 class="mb-1 mt-3">Boots4 - 3.1.0</h5>
                        <p class="mb-4">11 September, 2019</p>
                        <h6>Add</h6>
                        <ul class="pl-0 bullet-inside">
                          <li>Add <code>.gitignore </code>file</li>
                          <li>Add <code>README.md </code>file</li>
                          <li>Add <code>jTap </code>plugin to <code>/assets/lib </code>folder</li>
                        </ul>
                        <h6 class="mt-3">Update</h6>
                        <ul class="pl-0 bullet-inside">
                          <li>Update <code>theme.js</code></li>
                          <li>Remove <code>jTap </code>plugin from <code>packages.json</code></li>
                          <li>Remove <code>jTap </code>plugin path from <code>gulpfile.js</code></li>
                        </ul>
                      </div>
                    </div>
                  </div>
