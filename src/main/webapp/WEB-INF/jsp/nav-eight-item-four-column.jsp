...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!-- AI -->
    <link id="pagestyle" href="/assets/css/ai/soft-ui-dashboard.css" rel="stylesheet" />
    
    <!-- ITEGRATION -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" href="/assets/css/integration/fontawesome.css">
    <link rel="stylesheet" href="/assets/css/integration/templatemo-digimedia-v1.css">
    <link rel="stylesheet" href="/assets/css/integration/animated.css">
    <link rel="stylesheet" href="/assets/css/integration/owl.css">
	        ...
	        <div class="container">
	            ...
	            <div class="row">
	                ...
	                <div class="col-lg-4">
	                    <div class="text-box bg-gray">
	                        <h4>Great results</h4>
	                        <p>A lot of users have sent us positive feedback about</p>
	                    </div> <!-- end of text-box -->
	                </div> <!-- end of col -->
	            </div> <!-- end of row -->
	        </div> <!-- end of container -->
      ...
      <div class="page position-absolute t-0 w-100" id="portfolio">
        <div class="row no-gutters minh-100vh">
          <div class="col-lg-9 order-1 order-lg-0 page-content pt-6 pt-lg-0">
            ...
            <section class="our-services lightbox-basic">
        		<div class="container">
		            <div class="row">
		                <div class="col-lg-12">
		                ...
		                <div class="col-lg-4">
		                    <div class="service-item">
		                        ...
		                        <img src="/assets/img/about/service-01.jpg" alt="">
		                    </div>
		                </div>
		                <div class="col-lg-4">
		                    <div class="service-item">
		                        ...
		                        <p>Lorem ipsum dolor sit amet, consecteturti adipiscing elit, sed do eiusmod temp incididunt ut labore, et dolore quis ipsum suspend.</p>
		                        <img src="/assets/img/about/service-02.jpg" alt="">
		                    </div>
		                </div>
		                <div class="col-lg-4">
		                    <div class="service-item">
		                        ...
		                        <p>Lorem ipsum dolor sit amet, consecteturti adipiscing elit, sed do eiusmod temp incididunt ut labore, et dolore quis ipsum suspend.</p>
		                        <img src="/assets/img/about/service-03.jpg" alt="">
		                    </div>
		                </div>
		            </div>
		        </div>
      ...
      <div class="container text-center">
        <div class="row justify-content-center text-center">
          <div class="col-lg-10">
            ...
            <img src="/assets/img/rms/untree.co_dashboard_mocklayout_laptop.png" alt="image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center mb-5">
          <div class="col-lg-6 mb-5 order-lg-2 mb-lg-0" data-aos="fade-right">
            <img src="/assets/img/rms/untree.co_dashboard_mocklayout.jpg" alt="Image" class="img-fluid img-shadow">
          </div>
						          ...
						          <div class="row">
						            <div class="col-lg-6">
						              <div class="about-left-image  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
						                <img src="/assets/img/integration/about-dec.png" alt="">
						              </div>
						            </div>
						                ...
						                <div class="col-lg-12">
						                  <div class="menu">
						                    <div class="first-thumb active">
						                      <div class="thumb">
						                        <span class="icon"><img src="/assets/img/integration/service-icon-01.png" alt=""></span>
						                        Apartments
						                      </div>
						                    </div>
						                    <div>
						                      <div class="thumb">                 
						                        <span class="icon"><img src="/assets/img/integration/service-icon-02.png" alt=""></span>
						                        Food &amp; Life
						                      </div>
						                    </div>
						                    <div>
						                      <div class="thumb">                 
						                        <span class="icon"><img src="/assets/img/integration/service-icon-03.png" alt=""></span>
						                        Cars
						                      </div>
						                    </div>
						                    <div>
						                      <div class="thumb">                 
						                        <span class="icon"><img src="/assets/img/integration/service-icon-04.png" alt=""></span>
						                        Shopping
						                      </div>
						                    </div>
						                          ...
						                          <div class="row">
						                            ...
						                            <div class="col-lg-6 align-self-center">
						                              <div class="right-image">
						                                <img src="/assets/img/integration/services-image.jpg" alt="">
						                              </div>
						                            </div>
						                          </div>
						                        </div>
						                      ...
						                      <div>
						                        <div class="thumb">
						                          <div class="row">
						                            ...
						                            <div class="col-lg-6 align-self-center">
						                              <div class="right-image">
						                                <img src="/assets/img/integration/services-image-02.jpg" alt="">
						                              </div>
						                            </div>
						                          </div>
						                        </div>
						                      ...
						                      <div>
						                        <div class="thumb">
						                          <div class="row">
						                            ...
						                            <div class="col-lg-6 align-self-center">
						                              <div class="right-image">
						                                <img src="/assets/img/integration/services-image-03.jpg" alt="">
						                              </div>
						                            </div>
						                          </div>
						                        </div>
						                      ...
						                      <div>
						                        <div class="thumb">
						                          <div class="row">
						                            ...
						                            <div class="col-lg-6 align-self-center">
						                              <div class="right-image">
						                                <img src="/assets/img/integration/services-image-04.jpg" alt="">
						                              </div>
						                            </div>
						                          </div>
						                        </div>
						          ...
						          <div class="loop owl-carousel">
						            <div class="item">
						              <a href="#">
						                ...
						                <div class="thumb">
						                  <img src="/assets/img/integration/portfolio-01.jpg" alt="">
						                </div>
						            ...
						            <div class="item">
						              <a href="#">
						                <div class="portfolio-item">
						                <div class="thumb">
						                  <img src="/assets/img/integration/portfolio-02.jpg" alt="">
						                </div>
						                <div class="down-content">
						                  <h4>Website Builder</h4>
						                  <span>Marketing</span>
						            ...
						            <div class="item">
						              <a href="#">
						                <div class="portfolio-item">
						                <div class="thumb">
						                  <img src="/assets/img/integration/portfolio-03.jpg" alt="">
						                </div>
						                <div class="down-content">
						                  <h4>Website Builder</h4>
						                  <span>Marketing</span>
						            ...
						            <div class="item">
						              <a href="#">
						                <div class="portfolio-item">
						                <div class="thumb">
						                  <img src="/assets/img/integration/portfolio-04.jpg" alt="">
						                </div>
						                <div class="down-content">
						                  <h4>Website Builder</h4>
						                  <span>Marketing</span>
						    ...
						    <div class="container">
						      <div class="row" style="text-align:left;">
						        ...
						        <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
						          <div class="blog-post">
						            <div class="thumb">
						              <a href="#"><img src="/assets/img/integration/blog-post-01.jpg" style="width: 100%;" alt=""></a>
						            </div>
						            <div class="down-content">
						              ...
						              <span class="author"><img src="/assets/img/integration/author-post.jpg" alt="">By: Andrea Mentuzi</span>
						          ...
						          <div class="blog-posts">
						            <div class="row">
						              <div class="col-lg-12">
						                <div class="post-item">
						                  <div class="thumb">
						                    <a href="#"><img src="/assets/img/integration/blog-post-02.jpg" alt=""></a>
						                  </div>
						              ...
						              <div class="col-lg-12">
						                <div class="post-item">
						                  <div class="thumb">
						                    <a href="#"><img src="/assets/img/integration/blog-post-03.jpg" alt=""></a>
						                  </div>
						                  <div class="right-content">
						                    <span class="category">SEO Analysis</span>
						                    <span class="date">2021</span>
						              ...
						              <div class="col-lg-12">
						                <div class="post-item last-post-item">
						                  <div class="thumb">
						                    <a href="#"><img src="/assets/img/integration/blog-post-04.jpg" alt=""></a>
						                  </div>
						                  <div class="right-content">
						                    <span class="category">SEO Analysis</span>
						                    <span class="date">2021</span>
