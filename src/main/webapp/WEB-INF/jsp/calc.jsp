...
<html>
	<head>
		...
		<link href="/assert/css/estimate_style.css" rel="stylesheet" type="text/css">
		<script src="/assert/js/jquery-3.1.1.min.js"></script>
		<script src="/assert/js/estimate_script.js?ver=20220620"></script>
	</head>
	<body>
		<div id="wrap">
			<header id="header" class="row_flex">
    			<h1 id="logo"><img src="/assert/images/logo.png" alt="빙고로고이미지"></h1>
    			<h2>총 임대 예상비용 계산기</h2>
  			</header>
        			...
        			<div class="row_flex">
          				...
          				<div class="product_info">
            				...
            				<div class="product_size product_info_item">
              					<h3>컨테이너 사이즈</h3>
              					<p><img src="/assert/images/size_img.png" alt="빙고 컨테이너 이미지"></p>
            				...
            				<div class="option product_info_item">
              					<h3>추가옵션</h3>
              					<p class="column_flex">
                					<img src="/assert/images/option01.png" alt="1200x1800사이드도어 부착 컨테이너 이미지">
                					<img src="/assert/images/option02.png" alt="1500x1800사이드도어 부착 컨테이너 이미지">
              					</p>
            				</div>
            				<!-- option end -->
          				</div>
