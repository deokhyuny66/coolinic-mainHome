     ...
     <li><a href="https://blog.naver.com/vingoservice" target="_blank">블로그</a></li>
	  ...
	  <section id="sec01"> 
	    <div class="Characteristics_box">
	      ...
	      <div class="bk_box">
	        <div class="text_box">
	          <p class="main">빙고 매니저 지원으로<br>편리하게 빙고를 맞이하세요.</p>
	          <p class="sub">상담부터 설치 및 교육까지 전담 매니저가<br>모든 과정을 친절하고 정확하게 안내해 드립니다.</p>
	        </div>
	      </div>
	    </div>
	    <div class="Characteristics_box">
	      ...
	      <div class="bk_box">
	        <div class="text_box">
	          <p class="main">보증금과 위약금 없는<br>빙고를 선택하세요.</p>
	          <p class="sub">임대보증금과 해지위약금이 없는 합리적인<br>가격으로 임대 서비스를 제공합니다.</p>
	        </div>
	      </div>
	    </div>
	    <div class="Characteristics_box">
	      ...
	      <div class="bk_box">
	        <div class="text_box">
	          <p class="main">빙고 Live 서비스로<br>고장 걱정없이 편히 주무세요.</p>
	          <p class="sub">고장 발생 시 24시간 빙고 모니터링 센서가<br>먼저 알려드리고 긴급 조치까지 지원합니다.</p>
	        </div>
	      </div>
	    </div>
	  </section>
	  <section id="sec02">
	    <div class="cont_box">
	      <div>
	        ...
	        <p>언제 어디서나 내 손 안의 빙고라이브로 온도를 확인하세요.<br>빙고라이브는 실시간 온도와 고장 알람을 제공합니다.</p>
	  ...
	  <section id="sec03">
	    <div class="cont_box">
	      <div class="tab_content_box">
	        <h2 class="sec_tit">빙고 컨테이너는</h2>
	        <p class="sec_sub">컨테이너 별 사이즈 및 기타 정보들을 정확하게 확인해주세요.</p>
	        <ul id="tab_btn_box">
	        ...
	        <div id="tab_cont01" class="tab_cont">
	          <table class="container_size">
	            <th></th>
	            <th>내부<span class="unit">(m)</span></th>
	            <th>외부<span class="unit">(m)</span></th>
	            <th>개구부<span class="unit">(m)</span></th>
	            <tr>
	              <td>길이</td>
	              <td>5.5</td>
	              <td>6.1</td>
...
<!-- Mirae Talk Script END Ver 2.0   -->
	  <div id="popup_btn_box"> 
	    <div id="popup_btn">
	      <span></span>
	      <p><a href="https://www.vingo.co.kr/estimate/index" target="_blank">간편견적</a></p>
	    </div>
	  </div>
	</div>
